...
function fht(Vnl::NonLocalPotential{RealSpace,Analytical}, args...; kwargs...)
    return _apply(Vnl, fht, args...; kwargs...)
end
function fht(
    Vnl::NonLocalPotential{RealSpace,Numerical}, q::AbstractVector, args...; kwargs...
)
    return _apply(Vnl, fht, q::AbstractVector, args...; kwargs...)
end
function ifht(Vnl::NonLocalPotential{FourierSpace,Analytical}, args...; kwargs...)
    return _apply(Vnl, ifht, args...; kwargs...)
end
function ifht(
    Vnl::NonLocalPotential{FourierSpace,Numerical}, r::AbstractVector, args...; kwargs...
)
